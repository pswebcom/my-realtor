        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            <input
              ...
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mb-6 border"
            />
            <div className="relative mb-6">
              <input
                ...
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out border"
              />
              {/*-- npm i react-icons  */}
              {showPassword ? (
                <AiFillEyeInvisible
